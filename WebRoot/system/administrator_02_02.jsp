							...
							<tr>
								...
								<td>
									<select name="options" onchange="searchList();">
										...
										<option value="PermissionNames">
											PermissionNames
										</option>
										<option value="SkillLevels" selected>
											SkillLevels
										</option>
						...
						<table width="80%" border="0" cellpadding="3" cellspacing="1"
							...
							<logic:present name="list">
								<logic:iterate id="listrow" name="list" scope="request">
									<tr class="tr2">
										<td align="center">
											<bean:write name="listrow" property="skilllevelid"
												filter="true" />
										</td>
										<td align="center">
											<bean:write name="listrow" property="skilllevelname"
												filter="true" />
										</td>
									</tr>
								</logic:iterate>
